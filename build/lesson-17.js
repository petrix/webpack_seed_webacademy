...
*/
var aa=__webpack_require__(15),n=__webpack_require__(31),ba=__webpack_require__(53);function ca(a,b,c,d,e,f,g,h){if(!a){a=void 0;if(void 0===b)a=Error("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.");else{var k=[c,d,e,f,g,h],l=0;a=Error(b.replace(/%s/g,function(){return k[l++]}));a.name="Invariant Violation"}a.framesToPop=1;throw a;}}
...
var schedule = __webpack_require__(53);
var tracing = __webpack_require__(105);
...
ReactDOM.render(React.createElement(_App.App, null), document.querySelector('#root'));
...
var _TaskList = __webpack_require__(393);
    ...
    value: function render() {
      return React.createElement(
        ...
        React.createElement(
          'header',
          null,
          'HHere will be header'
        ),
        React.createElement(
          'section',
          { className: 'page__content' },
          React.createElement(_TaskList.TaskList, null)
        )
      );
    }
  }]);
...
var _TaskListHeader = __webpack_require__(394);

var _TaskListContent = __webpack_require__(395);
    ...
    _createClass(TaskList, [{
        ...
        value: function render() {
            return React.createElement(
                'div',
                { className: 'task-list' },
                React.createElement(_TaskListHeader.TaskListHeader, { onSuccessSubmit: this.addTask.bind(this) }),
                React.createElement(_TaskListContent.TaskListContent, { tasks: this.state.tasks }),
                React.createElement('div', { className: 'task-list__footer' })
            );
        }
    }]);
...
exports.TaskListHeader = undefined;
...
var TaskListHeader = exports.TaskListHeader = function (_React$Component) {
  _inherits(TaskListHeader, _React$Component);

  function TaskListHeader() {
    _classCallCheck(this, TaskListHeader);

    var _this = _possibleConstructorReturn(this, (TaskListHeader.__proto__ || Object.getPrototypeOf(TaskListHeader)).call(this));
  ...
  _createClass(TaskListHeader, [{
    ...
    value: function submitHandler(e) {
      ...
      xhr.onreadystatechange = function () {
        if (xhr.readyState === 4) {
          if (xhr.status === 200) {
            _this2.setState({ title: '' });
            _this2.props.onSuccessSubmit(JSON.parse(xhr.response));
          }
        }
      };
    }
    ...
    value: function render() {
      return React.createElement(
        'form',
        { className: 'task-list__header', onSubmit: this.submitHandler.bind(this) },
        React.createElement(
          'h1',
...
exports.TaskListContent = undefined;
...
var TaskListContent = exports.TaskListContent = function (_React$Component) {
    _inherits(TaskListContent, _React$Component);

    function TaskListContent() {
        _classCallCheck(this, TaskListContent);

        return _possibleConstructorReturn(this, (TaskListContent.__proto__ || Object.getPrototypeOf(TaskListContent)).apply(this, arguments));
    }

    _createClass(TaskListContent, [{
        key: "render",
        value: function render() {
            var listItems = [];
            ...
            try {
                for (var _iterator = this.props.tasks[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                    var item = _step.value;

                    var li = React.createElement(
                        "li",
                        { className: "task-list__item", key: item.id },
                        item.title
                    );
                    listItems.push(li);
                }
