...
var moment = __webpack_require__(542);
...
function mainWeather(weatherLat, weatherLong) {
	...
	var apiKey = "811020b89fdaa50887e8f5bac707174a";
	var url = "https://api.darksky.net/forecast/";
	// var lati = 50.9492;
	// var longi = 30.2034;
	var data;
	var iconvalue = ["clear-day", "cloudy", "snow", "partly-cloudy-day", "partly-cloudy-night", "fog", "rain", "wind", "clear-night"];
	...
	$.getJSON(url + apiKey + "/" + weatherLat + "," + weatherLong + "?units=uk&lang=ru&callback=?", function (data) {
		...
		for (i = 0; i < 7; i++) {
			...
			$(".daily").append('<article><div class="row1">' + "<span>" + dailytime + "</span>" + mainIconbig + "</div>" + "<hr>" + "<span>" + dailysum + "</span>" + '<div class="precip' + dayprecipShow + '">' + "<b>" + dayprecipProbability + " - " + dayprecipIntensityMaxTime + " - " + dayprecipType + "</b>" + "</div>" + '<div class="row2" style="background-image: linear-gradient(to right,#006ac0 ' + (dailysunrisePercent - 1) + "%," + "#c07600 " + dailysunrisePercent + "%," + "#c07600 " + (dailysunsetPercent - 1) + "%," + "#006ac0 " + dailysunsetPercent + "%" + ')">' + "<div>" + "<p>sunrise</p><b>" + dailysunrise + "</b>" + "<p>sunset</p><b>" + dailysunset + "</b>" + "</div>" + "<div>" + "<p>tempHigh</p><b>" + dailytemperatureHigh + " - " + dailytemperatureHighTime + "</b>" +
			// '<b> - ' + '</b>' +
			"<p>tempLow</p><b>" + dailytemperatureLow + " - " + dailytemperatureLowTime + "</b>" +
			// '<b> - ' +'</b>' +
			"</div>" + "<div>" + "<p>moonPhase</p><b>" + daymoonPhase + "</b>" + "<p>visibility</p><b>" + dayvisibility + "</b>" + "<p>pressure</p><b>" + daypressure + "</b>" + "</div>" + "<div>" + "<p>cloudCover</p><b>" + daycloudCover + "</b>" + "<p>humidity</p><b>" + dayhumidity + "</b>" + "<p>dewPoint</p><b>" + daydewPoint + "</b>" + "</div>" + "<div>" + "<p>ozone</p><b>" + dayozone + "</b>" + "<p>uvIndex</p><b>" + dayuvIndex + "</b>" + "<b> - " + dayuvIndexTime + "</b>" + "</div>" +
...
var moment = module.exports = __webpack_require__(543);
moment.tz.load(__webpack_require__(544));
