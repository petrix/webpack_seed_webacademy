...
var moment = __webpack_require__(427);
...
$(document).ready(function () {
    ...
    var longi = 30.2034;
    var data;
    var iconvalue = ['cloudy', 'snow', 'partly-cloudy-day', 'partly-cloudy-night', 'fog'];
    var iconimage = ['<div class="icon cloudy"></div>', '<div class="icon snow"></div>', '<div class="icon partly-cloudy-day"></div>', '<div class="icon partly-cloudy-night"></div>', '<div class="icon fog"></div>'];
    var iconimagebig = ['<div class="iconbig cloudy"></div>', '<div class="iconbig snow"></div>', '<div class="iconbig partly-cloudy-day"></div>', '<div class="iconbig partly-cloudy-night"></div>', '<div class="iconbig fog"></div>'];
    moment.locale('be');
...
$.fn.LocationRegionPicker = function (options) {
	return this.each(function () {
		if (!$.data(this, 'LocationRegionPicker')) {
			$.data(this, 'LocationRegionPicker', new LocationRegionPicker(this, options));
		}
	});
};
